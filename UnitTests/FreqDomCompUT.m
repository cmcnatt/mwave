...
Contributors:
    C. McNatt
%}
classdef FreqDomCompUT < matlab.unittest.TestCase
    % Unit test for FreqDomComp class
    ...
    methods (Test)
        function testDiffMatSize(testCase)
            ...
            hb = FreqDomComp(hbc_ut_1_1_1_hydroF, hbc_ut_1_1_1_floatB);
            ...
            hb = FreqDomComp (hbc_ut_1_1_dof_hydroF, hbc_ut_1_1_dof_floatB);
            ...
            hb = FreqDomComp (hbc_ut_1_b_1_hydroF, hbc_ut_1_b_1_floatB);
            ...
            hb = FreqDomComp (hbc_ut_1_b_dof_hydroF, hbc_ut_1_b_dof_floatB);
            ...
            hb = FreqDomComp (hbc_ut_T_1_1_hydroF, hbc_ut_T_1_1_floatB);
            ...
            hb = FreqDomComp (hbc_ut_T_1_dof_hydroF, hbc_ut_T_1_dof_floatB);
            ...
            hb = FreqDomComp (hbc_ut_T_b_1_hydroF, hbc_ut_T_b_1_floatB);
            ...
            hb = FreqDomComp(hbc_ut_T_b_dof_hydroF, hbc_ut_T_b_dof_floatB);
...
%             errFex = matErr(Fex, Fexw);
            ...
            title({'FreqDomCompUT', 'Wamit Total Wave Field'});
            
            subplot(2,1,2)
            pcolor(X,Y,abs(etaB{1}));
            fet;
            set(gca, 'clim', [0.8 1.2], 'xtick', [], 'ytick', []);
            title({'FreqDomComp Total Wave Field'});
        end
    end
end