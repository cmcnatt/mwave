...
Contributors:
    C. McNatt
%}
classdef FreqDomArrayCompUT < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test2CylComp(testCase)
            ...
            aComp = FreqDomArrayComp(hbs, iwaves);
...
%             errFex = matErr(Fex, Fexw);
            ...
            for n = 1:5
                ...
                if (n == 1)
                    title({'FreqDomArrayCompUT', 'Wamit Total Wave Field'});
                end
                ylabel(['\beta = ' bet{n}]);
                ...
                set(gca, 'clim', [0.8 1.2], 'xtick', [], 'ytick', []);
                if (n == 1)
                    title({'FreqDomArrayComp Total Wave Field'});
                end
            end
        end
        ...
        function testIncCirWave(testCase)
            ...
            R = 2;
            randPhase = true;
            coefs = FreqDomArrayCompUT.cirCoefs(t, h, s, R, randPhase);
            ...
            title({'FreqDomArrayCompUT', 'Short-crested Wave Field'});
        end
    end
