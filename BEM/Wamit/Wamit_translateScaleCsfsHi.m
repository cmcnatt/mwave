...
for m = 1:Ngdf
    ...
    for n = 1:Npatcsf(m)
        ...
        for ii = 1:Nv
            for i = 1:3
                fprintf(fid, ' %8.4f', scale*(verts{m}{n}(ii,i)) + delta(i)); % The precision here was reduced to sidestep an error where wamit thought the panels were above the free surface
            end
            fprintf(fid, '\n');
        end
        fprintf(fid, '\n');
