...
Contributors:
    C. McNatt
%}
classdef HydroArrayComp < IHydroComp
    ...
    properties (Dependent)
     ...
     methods
         ...
         function [hacomp] = HydroArrayComp(hydroBs, iwaves)            
     ...
     methods (Access = private)
         ...
         function [Ai, Ar, M] = incRadAmps(hacomp, iT, iBod, iMode)
             ...
             for n = 1:hacomp.Nhb
                 ...
                 if (n ~= iBod)
                     aIa(n1:n2) = HydroArrayComp.rAmps(iT, M, hacomp.hbs(n), hacomp.hbs(iBod), iMode, hacomp.k0(iT));
                 end
             end
