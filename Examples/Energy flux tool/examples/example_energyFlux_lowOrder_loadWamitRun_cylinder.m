% script which opens a saved hydrodynamic simulation for a floating cylinder
% and computes the energy flux through the surface 

% to run this script you require

% 1. mwave (https://github.com/cmcnatt/mwave)

% CELL ORDER
% 1. load saved WAMIT result
% 2. plot save geometry
% 3. compute energy flux
% 4. plot metrics
% 5. compare methods

clear; clc; close all;
%% load WAMIT result and plot geometry being analysed

geoFileName = 'cylinder'; % name of geometry
wamFilePath =[energyFluxToolPath '\wamitResults']; % location of wamit results
load([wamFilePath '\' geoFileName]) % load the files
